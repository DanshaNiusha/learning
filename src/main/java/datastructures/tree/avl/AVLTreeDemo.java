...
public class AVLTreeDemo {
    ...
    public static void main(String[] args) {
        ...
        Arrays.stream(arr).forEach(i -> avlTree.add(new Node(i)));
        avlTree.infixOrder();
        // 转之前和转之后遍历出来的顺序是一样的, 都已经是bst了, 只不过高度不一样
...
class Node {
    ...
    public void add(Node node) {
        ...
        /**
         * 旋转逻辑,如果添加完一个节点以后左子树高, 就向右边转, 如果右边高, 就像左转
         */
    ...
    private void leftRotate() {
        ...
        // 找柚子节点的左节点放到左子树的右子节点 因为是二叉排序树, 所以构造出来的还是二叉排序树
